...
public:
	...
	{
		return Memory::CallVFunc<int>(this, 8);
	}

	int GetCurrentGameMode()
	{
		return Memory::CallVFunc<int>(this, 9);
	}

	const char* GetCurrentMapName()
	{
		return Memory::CallVFunc<const char*>(this, 10);
	}

	const char* GetCurrentGameTypeNameID()
	{
		return Memory::CallVFunc<const char*>(this, 11);
	}

	const char* GetCurrentGameModeNameID()
	{
		return Memory::CallVFunc<const char*>(this, 13);
	}
};
