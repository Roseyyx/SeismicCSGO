...
public:
	ITexture* GetTexture()	
	{
		return Memory::CallVFunc<ITexture*>(this, 1);
	}

	void SetFloat(float flValue)
	{
		Memory::CallVFunc<void>(this, 4, flValue);
	}

	void SetInt(int iValue)
	{
		Memory::CallVFunc<void>(this, 5, iValue);
	}

	void SetString(const char* szValue)
	{
		Memory::CallVFunc<void>(this, 6, szValue);
	}

	void SetVector(float x, float y)
	{
		Memory::CallVFunc<void>(this, 10, x, y);
	}

	void SetVector(float x, float y, float z)
	{
		Memory::CallVFunc<void>(this, 11, x, y, z);
	}

	void SetTexture(ITexture* pTexture)
	{
		Memory::CallVFunc<void>(this, 15, pTexture);
	}

	void SetVectorComponent(float flValue, int iComponent)
	{
		Memory::CallVFunc<void>(this, 26, flValue, iComponent);
	}
};
